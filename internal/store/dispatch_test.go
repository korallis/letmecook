...
const dropDispatchSchema = `DROP TABLE dispatch_acks; DROP TABLE dispatch_releases; DROP TABLE dispatches; DROP TABLE dispatch_eligibility; DROP TABLE dispatch_stops;`
