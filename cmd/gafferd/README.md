...
3, 4, 5, 6 or 7 (current). New persistent opens migrate to 7; clients retain historical
schema 2/3/4/5/6 reads. Schema 7 stores provisional local artifact-custody metadata only; neither response exposes grants,
