...
export type Reason = 'unauthorized' | 'policy_denied' | 'unsupported_request' | 'request_limit' | 'response_limit' |
  'concurrency_limit' | 'attempt_limit' | 'deadline' | 'cancelled' | 'upstream_failure' | 'invalid_stream' | 'boundary_closed';
...
export function fixturePolicy(overrides: Partial<Limits> = {}): Policy {
