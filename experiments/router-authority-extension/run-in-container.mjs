...
for(const scenario of ['success','tools','account-fallback','model-fallback','refresh','proactive-refresh','sse-retry','retry-cancel','fence-retry','preheaders-cancel','fence-preheaders','refresh-cancel','failed','incomplete','partial','contradictory','oversized']) results.push(await run('native-integration.mjs',scenario,{native:true,data:'native-'+scenario}));
