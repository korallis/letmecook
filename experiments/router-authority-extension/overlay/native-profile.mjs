...
export function nativeConsumerRole(profile){if(profile.protocol===NATIVE_PROTOCOL)return 'worker';if(profile.protocol===PLANNER_PROTOCOL)return 'planner';throw Error('unsupported_native_consumer');}
